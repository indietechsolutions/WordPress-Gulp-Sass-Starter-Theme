<?php
/**
 * _lhstartertheme functions and definitions
 *
...
// add_action( 'tgmpa_register', 'lh_register_required_plugins' );
 ...
 */
add_action( 'admin_init', 'lh_add_post_type_caps' );
function lh_add_post_type_caps() {
	// lh_add_capabilities( 'portfolio' );
}

/**
 * Filter Yoast SEO Metabox Priority
 */
add_filter( 'wpseo_metabox_prio', 'lh_filter_yoast_seo_metabox' );
function lh_filter_yoast_seo_metabox() {
	return 'low';
}
